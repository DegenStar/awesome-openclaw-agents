...
### 2. It automatically identifies the system and configures the environment and installs any missing dependencies (including the latest `node.js/npm` and packages and dependencies required for some common skills).
